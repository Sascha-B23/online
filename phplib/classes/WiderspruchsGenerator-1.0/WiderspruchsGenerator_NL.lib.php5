<?php
/**
 * Widerspruchsgenerator (Niederlande)
 * 
 * @access   	public
 ...
 */
class WiderspruchsGenerator_NL extends WiderspruchsGenerator
{
	/**
	 * Textbausteine (pkeys)
	 */
	const WG_WIDERSPRUCHSPUNKT_HEIZKOSTEN = 95;									// Heizkosten										OK
	const WG_WIDERSPRUCHSPUNKT_ENTSORGUNG = 93;									// Entsorgung										OK
	const WG_WIDERSPRUCHSPUNKT_REINIGUNG_UND_PFLEGE = 107;						// Reinigung und Pflege								OK
	const WG_WIDERSPRUCHSPUNKT_ALLGEMEINSTROM = 85;								// Allgemeinstrom									OK
	const WG_WIDERSPRUCHSPUNKT_WARTUNG_INSTANDHALTUNG_INSTANDSETZUNG = 121;		// Wartung, Instandhaltung und Instandsetzung		OK
	const WG_WIDERSPRUCHSPUNKT_AUSZAHLUNG_GUTSCHRIFT = 87;						// Auszahlung Gutschrift							OK
	const WG_WIDERSPRUCHSPUNKT_REDUZIERUNG_VORAUSZAHLUNG = 101;					// Reduzierung Vorauszahlung						OK
	const WG_WIDERSPRUCHSPUNKT_OEFFENTLICHE_ABGABEN = 105;						// Öffentliche Abgaben								OK
	const WG_WIDERSPRUCHSPUNKT_VERSICHERUNGEN = 113;							// Versicherung										OK
	const WG_WIDERSPRUCHSPUNKT_VERWALTUNG_UND_MANAGEMENT = 115;					// Verwaltung und Management						OK
	const WG_WIDERSPRUCHSPUNKT_UMLAGEFLAECHE = 111;								// Umlagefläche										OK
	const WG_WIDERSPRUCHSPUNKT_BERECHNUNGSFEHLER = 89;							// Berechnungsfehler								OK
	const WG_WIDERSPRUCHSPUNKT_VORAUSZAHLUNG = 117;								// Vorauszahlung									OK
	const WG_WIDERSPRUCHSPUNKT_NICHT_VEREINBARTE_ABRECHNUNGSPOSITIONEN = 103;	// Nicht vereinbarte Abrechnungspositionen			OK
	const WG_WIDERSPRUCHSPUNKT_LUEFTUNG_UND_KLIMATISIERUNG = 99;				// Lüftung und Klimatisierung						OK
	const WG_WIDERSPRUCHSPUNKT_SONSTIGES = 109;									// Sonstige											OK
	const WG_WIDERSPRUCHSPUNKT_KOSTENSTEIGERUNG = 97;							// Kostensteigerung									OK
	const WG_WIDERSPRUCHSPUNKT_ZUSAMMENSETZUNG_GU = 123;						// Zusammensetzung Gesamteinheiten Umlageschlüssel	OK
	const WG_WIDERSPRUCHSPUNKT_ZUSAMMENSETZUNG_GESAMTKOSTEN = 125;				// Zusammensetzung Gesamtkosten						OK
	const WG_WIDERSPRUCHSPUNKT_ABGRENZUNG = 83;									// Abgrenzungen										OK
	const WG_WIDERSPRUCHSPUNKT_BERECHNUNGSFEHLER_ABRECHNUNGSERGEBNIS = 91;		// Berechnungsfehler Abrechnungsergebnis			OK
	const WG_WIDERSPRUCHSPUNKT_GESAMTKOSTENDECKELUNG = 119;						// Gesamtkostendeckelung							OK

	/**
	 * Konstruktor
	 * @param DBManager $db
	 */
	public function WiderspruchsGenerator_NL(DBManager $db)
	{
