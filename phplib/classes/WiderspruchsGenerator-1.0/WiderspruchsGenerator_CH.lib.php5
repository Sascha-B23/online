 ...
 */
class WiderspruchsGenerator_CH extends WiderspruchsGenerator
{
	/**
	 * Textbausteine (pkeys)
	 */
	const WG_WIDERSPRUCHSPUNKT_HEIZKOSTEN = 58;									// Heizkosten
	const WG_WIDERSPRUCHSPUNKT_ENTSORGUNG = 63;									// Entsorgung
	const WG_WIDERSPRUCHSPUNKT_REINIGUNG_UND_PFLEGE = 64;						// Reinigung und Pflege
	const WG_WIDERSPRUCHSPUNKT_ALLGEMEINSTROM = 60;								// Allgemeinstrom
	const WG_WIDERSPRUCHSPUNKT_WARTUNG_INSTANDHALTUNG_INSTANDSETZUNG = 56;		// Wartung, Instandhaltung und Instandsetzung
	const WG_WIDERSPRUCHSPUNKT_AUSZAHLUNG_GUTSCHRIFT = 73;						// Auszahlung Gutschrift
	const WG_WIDERSPRUCHSPUNKT_REDUZIERUNG_VORAUSZAHLUNG = 74;					// Reduzierung Vorauszahlung
	const WG_WIDERSPRUCHSPUNKT_OEFFENTLICHE_ABGABEN = 62;						// Öffentliche Abgaben
	const WG_WIDERSPRUCHSPUNKT_VERSICHERUNGEN = 61;								// Versicherung
	const WG_WIDERSPRUCHSPUNKT_VERWALTUNG_UND_MANAGEMENT = 57;					// Verwaltung und Management
	const WG_WIDERSPRUCHSPUNKT_UMLAGEFLAECHE = 68;								// Umlagefläche
	const WG_WIDERSPRUCHSPUNKT_BERECHNUNGSFEHLER = 72;							// Berechnungsfehler
	const WG_WIDERSPRUCHSPUNKT_VORAUSZAHLUNG = 71;								// Vorauszahlung
	const WG_WIDERSPRUCHSPUNKT_NICHT_VEREINBARTE_ABRECHNUNGSPOSITIONEN = 55;	// Nicht vereinbarte Abrechnungspositionen
	const WG_WIDERSPRUCHSPUNKT_LUEFTUNG_UND_KLIMATISIERUNG = 59;				// Lüftung und Klimatisierung
	const WG_WIDERSPRUCHSPUNKT_SONSTIGES = 65;									// Sonstige
	const WG_WIDERSPRUCHSPUNKT_KOSTENSTEIGERUNG = 66;							// Kostensteigerung
	const WG_WIDERSPRUCHSPUNKT_ZUSAMMENSETZUNG_GU = 67;							// Zusammensetzung Gesamteinheiten Umlageschlüssel
	const WG_WIDERSPRUCHSPUNKT_ZUSAMMENSETZUNG_GESAMTKOSTEN = 69;				// Zusammensetzung Gesamtkosten 
	const WG_WIDERSPRUCHSPUNKT_ABGRENZUNG = 70;									// Abgrenzungen 
	 ...
	 * @param DBManager $db
	 */
	public function WiderspruchsGenerator_CH(DBManager $db)
	{
