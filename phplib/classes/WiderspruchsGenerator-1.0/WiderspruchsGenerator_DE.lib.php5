<?php
/**
 * Widerspruchsgenerator (Deutschland)
 * 
 * @access   	public
 ...
 */
class WiderspruchsGenerator_DE extends WiderspruchsGenerator
{
	/**
	 * Textbausteine (pkeys)
	 */
	const WG_WIDERSPRUCHSPUNKT_HEIZKOSTEN = 4;									// Heizkosten
	const WG_WIDERSPRUCHSPUNKT_ENTSORGUNG = 5;									// Entsorgung
	const WG_WIDERSPRUCHSPUNKT_REINIGUNG_UND_PFLEGE = 6;						// Reinigung und Pflege
	const WG_WIDERSPRUCHSPUNKT_ALLGEMEINSTROM = 7;								// Allgemeinstrom
	const WG_WIDERSPRUCHSPUNKT_WARTUNG_INSTANDHALTUNG_INSTANDSETZUNG = 8;		// Wartung, Instandhaltung und Instandsetzung
	const WG_WIDERSPRUCHSPUNKT_AUSZAHLUNG_GUTSCHRIFT = 12;						// Auszahlung Gutschrift
	const WG_WIDERSPRUCHSPUNKT_REDUZIERUNG_VORAUSZAHLUNG = 14;					// Reduzierung Vorauszahlung
	const WG_WIDERSPRUCHSPUNKT_OEFFENTLICHE_ABGABEN = 15;						// Öffentliche Abgaben
	const WG_WIDERSPRUCHSPUNKT_VERSICHERUNGEN = 16;								// Versicherung
	const WG_WIDERSPRUCHSPUNKT_VERWALTUNG_UND_MANAGEMENT = 17;					// Verwaltung und Management
	const WG_WIDERSPRUCHSPUNKT_UMLAGEFLAECHE = 19;								// Umlagefläche
	const WG_WIDERSPRUCHSPUNKT_BERECHNUNGSFEHLER = 21;							// Berechnungsfehler
	const WG_WIDERSPRUCHSPUNKT_VORAUSZAHLUNG = 22;								// Vorauszahlung
	const WG_WIDERSPRUCHSPUNKT_NICHT_VEREINBARTE_ABRECHNUNGSPOSITIONEN = 23;	// Nicht vereinbarte Abrechnungspositionen
	const WG_WIDERSPRUCHSPUNKT_LUEFTUNG_UND_KLIMATISIERUNG = 24;				// Lüftung und Klimatisierung
	const WG_WIDERSPRUCHSPUNKT_SONSTIGES = 25;									// Sonstige
	const WG_WIDERSPRUCHSPUNKT_KOSTENSTEIGERUNG = 26;							// Kostensteigerung
	const WG_WIDERSPRUCHSPUNKT_ZUSAMMENSETZUNG_GU = 27;							// Zusammensetzung Gesamteinheiten Umlageschlüssel
	const WG_WIDERSPRUCHSPUNKT_ZUSAMMENSETZUNG_GESAMTKOSTEN = 28;				// Zusammensetzung Gesamtkosten 
	const WG_WIDERSPRUCHSPUNKT_ABGRENZUNG = 29;									// Abgrenzungen 
	 ...
	 * @param DBManager $db
	 */
	public function WiderspruchsGenerator_DE(DBManager $db)
	{
