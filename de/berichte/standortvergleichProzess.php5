...
$USER_MANAGER_ACTION = UM_ACTION_SHOW_REPORT_STANDORTVERGLEICH_PROZESS;
if ($_POST["print"]!="")
{
...
$report = new ProzessStatusReport($db, $_SESSION["currentUser"], $customerManager, $addressManager, $userManager, $rsKostenartManager, $em, $lm);
