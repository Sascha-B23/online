...
if (isset($_POST["widerspruchID"]))
{
	...
	$widerspruch->Load($_POST["widerspruchID"], $db);
	$object->SetWiderspruch($widerspruch);
}
...
$form=new TwoColumnForm("javascript:ReturnToOpener();", new WiderspruchspunktFormData($_POST, $object, $db) );
