...
if( $_GET["taId"]!="" )$_POST["taId"]=$_GET["taId"];
if( isset($_POST["taId"]) && !is_numeric($_POST["taId"]) )unset($_POST["taId"]);
...
$form=new ThreeColumnForm("javascript:ReturnToOpener();", new TeilabrechnungspositionCopyMartixFormData($_POST, $object, $db) );
$form->PrintData(); 
