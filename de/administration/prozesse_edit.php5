...
if ($object->Load($_POST["editElement"], $db)===true)
{
	$form=new OneColumnForm( $DOMAIN_HTTP_ROOT."de/administration/prozesse.php5?UID=".$UID, new AdminProzessFormData($_POST, $object, $db) );
	$form->PrintData(); 
}
