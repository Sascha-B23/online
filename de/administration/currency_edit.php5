...
$object = new CCurrency($db);
$form=new OneColumnForm( $DOMAIN_HTTP_ROOT."de/administration/countries_currencies.php5?UID=".$UID, new CCurrencyFormData($_POST, $object, $db) );
$form->PrintData(); 
