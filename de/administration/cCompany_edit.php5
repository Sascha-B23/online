...
$cCompany = new CCompany($db);
$form=new OneColumnForm( $DOMAIN_HTTP_ROOT."de/administration/kundendatenbank.php5?UID=".$UID, new CustomerCompanyFormData($_POST, $cCompany, $db) );
$form->PrintData(); 
