...
if( isset($_POST["editElement"]) && $user->Load((int)$_POST["editElement"], $db)===true ){
...
$form = new OneColumnForm( $DOMAIN_HTTP_ROOT."de/administration/user.php5?UID=".$UID, new UserFormData($_POST, $user, $db) );
$form->PrintData(); 
