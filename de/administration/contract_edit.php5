...
// Form in der UI erzeugen ... ContractFormData soll vorausgefüllt werden

$form=new OneColumnForm( $DOMAIN_HTTP_ROOT."de/administration/contracts.php5?UID=".$UID, new ContractFormData($_POST, $contract, $db) );
