...
$cLocation = new CLocation($db);
$form=new OneColumnForm( $DOMAIN_HTTP_ROOT."de/administration/kundendatenbank.php5?UID=".$UID, new CustomerLocationFormData($_POST, $cLocation, $db) );
$form->PrintData(); 
